...
class AssetServiceRestTransport(AssetServiceTransport):
    ...
    """
    _STUBS: Dict[str, AssetServiceRestStub] = {}
    ...
    class _AnalyzeIamPolicy(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.AnalyzeIamPolicyRequest.to_dict(request)
            ...
            query_params = json.loads(asset_service.AnalyzeIamPolicyRequest.to_json(
                asset_service.AnalyzeIamPolicyRequest(transcoded_request['query_params']),
            ...
            # Return the response
            resp = asset_service.AnalyzeIamPolicyResponse.from_json(
                response.content,
    ...
    class _AnalyzeIamPolicyLongrunning(AssetServiceRestStub):
        ...
        longrunning method over HTTP.
            ...
            request_kwargs = asset_service.AnalyzeIamPolicyLongrunningRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = asset_service.AnalyzeIamPolicyLongrunningRequest.to_json(
                asset_service.AnalyzeIamPolicyLongrunningRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.AnalyzeIamPolicyLongrunningRequest.to_json(
                asset_service.AnalyzeIamPolicyLongrunningRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _BatchGetAssetsHistory(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.BatchGetAssetsHistoryRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.BatchGetAssetsHistoryRequest.to_json(
                asset_service.BatchGetAssetsHistoryRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.BatchGetAssetsHistoryResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _CreateFeed(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.CreateFeedRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = asset_service.CreateFeedRequest.to_json(
                asset_service.CreateFeedRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.CreateFeedRequest.to_json(
                asset_service.CreateFeedRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.Feed.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _DeleteFeed(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.DeleteFeedRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.DeleteFeedRequest.to_json(
                asset_service.DeleteFeedRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ExportAssets(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.ExportAssetsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = asset_service.ExportAssetsRequest.to_json(
                asset_service.ExportAssetsRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.ExportAssetsRequest.to_json(
                asset_service.ExportAssetsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _GetFeed(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.GetFeedRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.GetFeedRequest.to_json(
                asset_service.GetFeedRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ListAssets(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.ListAssetsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.ListAssetsRequest.to_json(
                asset_service.ListAssetsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.ListAssetsResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _ListFeeds(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.ListFeedsRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.ListFeedsRequest.to_json(
                asset_service.ListFeedsRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.ListFeedsResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _SearchAllIamPolicies(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.SearchAllIamPoliciesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.SearchAllIamPoliciesRequest.to_json(
                asset_service.SearchAllIamPoliciesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.SearchAllIamPoliciesResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _SearchAllResources(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.SearchAllResourcesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.SearchAllResourcesRequest.to_json(
                asset_service.SearchAllResourcesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = asset_service.SearchAllResourcesResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _UpdateFeed(AssetServiceRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = asset_service.UpdateFeedRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = asset_service.UpdateFeedRequest.to_json(
                asset_service.UpdateFeedRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(asset_service.UpdateFeedRequest.to_json(
                asset_service.UpdateFeedRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def analyze_iam_policy(self) -> Callable[
            ...
            asset_service.AnalyzeIamPolicyResponse]:
        stub = self._STUBS.get("analyze_iam_policy")
        if not stub:
            stub = self._STUBS["analyze_iam_policy"] = self._AnalyzeIamPolicy(self._session, self._host, self._interceptor)
    ...
    def analyze_iam_policy_longrunning(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("analyze_iam_policy_longrunning")
        if not stub:
            stub = self._STUBS["analyze_iam_policy_longrunning"] = self._AnalyzeIamPolicyLongrunning(self._session, self._host, self._interceptor)
    ...
    def batch_get_assets_history(self) -> Callable[
            ...
            asset_service.BatchGetAssetsHistoryResponse]:
        stub = self._STUBS.get("batch_get_assets_history")
        if not stub:
            stub = self._STUBS["batch_get_assets_history"] = self._BatchGetAssetsHistory(self._session, self._host, self._interceptor)
    ...
    def create_feed(self) -> Callable[
            ...
            asset_service.Feed]:
        stub = self._STUBS.get("create_feed")
        if not stub:
            stub = self._STUBS["create_feed"] = self._CreateFeed(self._session, self._host, self._interceptor)
    ...
    def delete_feed(self) -> Callable[
            ...
            empty_pb2.Empty]:
        stub = self._STUBS.get("delete_feed")
        if not stub:
            stub = self._STUBS["delete_feed"] = self._DeleteFeed(self._session, self._host, self._interceptor)
    ...
    def export_assets(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("export_assets")
        if not stub:
            stub = self._STUBS["export_assets"] = self._ExportAssets(self._session, self._host, self._interceptor)
    ...
    def get_feed(self) -> Callable[
            ...
            asset_service.Feed]:
        stub = self._STUBS.get("get_feed")
        if not stub:
            stub = self._STUBS["get_feed"] = self._GetFeed(self._session, self._host, self._interceptor)
    ...
    def list_assets(self) -> Callable[
            ...
            asset_service.ListAssetsResponse]:
        stub = self._STUBS.get("list_assets")
        if not stub:
            stub = self._STUBS["list_assets"] = self._ListAssets(self._session, self._host, self._interceptor)
    ...
    def list_feeds(self) -> Callable[
            ...
            asset_service.ListFeedsResponse]:
        stub = self._STUBS.get("list_feeds")
        if not stub:
            stub = self._STUBS["list_feeds"] = self._ListFeeds(self._session, self._host, self._interceptor)
    ...
    def search_all_iam_policies(self) -> Callable[
            ...
            asset_service.SearchAllIamPoliciesResponse]:
        stub = self._STUBS.get("search_all_iam_policies")
        if not stub:
            stub = self._STUBS["search_all_iam_policies"] = self._SearchAllIamPolicies(self._session, self._host, self._interceptor)
    ...
    def search_all_resources(self) -> Callable[
            ...
            asset_service.SearchAllResourcesResponse]:
        stub = self._STUBS.get("search_all_resources")
        if not stub:
            stub = self._STUBS["search_all_resources"] = self._SearchAllResources(self._session, self._host, self._interceptor)
    ...
    def update_feed(self) -> Callable[
            ...
            asset_service.Feed]:
        stub = self._STUBS.get("update_feed")
        if not stub:
            stub = self._STUBS["update_feed"] = self._UpdateFeed(self._session, self._host, self._interceptor)
