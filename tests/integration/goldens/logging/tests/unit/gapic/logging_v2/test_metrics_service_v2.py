...
def test_list_log_metrics_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        json_return_value = logging_metrics.ListLogMetricsResponse.to_json(return_value)
...
def test_get_log_metric_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        json_return_value = logging_metrics.LogMetric.to_json(return_value)
        response_value._content = json_return_value.encode('UTF-8')
        req.return_value = response_value
        response = client.get_log_metric(request)
