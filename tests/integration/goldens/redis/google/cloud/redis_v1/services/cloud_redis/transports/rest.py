...
class CloudRedisRestTransport(CloudRedisTransport):
    ...
    """
    _STUBS: Dict[str, CloudRedisRestStub] = {}
    ...
    class _CreateInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.CreateInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = cloud_redis.Instance.to_json(
                cloud_redis.Instance(transcoded_request['body']),                including_default_value_fields=False,
            ...
            query_params = json.loads(cloud_redis.CreateInstanceRequest.to_json(
                cloud_redis.CreateInstanceRequest(transcoded_request['query_params']),
    ...
    class _DeleteInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.DeleteInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.DeleteInstanceRequest.to_json(
                cloud_redis.DeleteInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ExportInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.ExportInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = cloud_redis.ExportInstanceRequest.to_json(
                cloud_redis.ExportInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.ExportInstanceRequest.to_json(
                cloud_redis.ExportInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _FailoverInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.FailoverInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = cloud_redis.FailoverInstanceRequest.to_json(
                cloud_redis.FailoverInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.FailoverInstanceRequest.to_json(
                cloud_redis.FailoverInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _GetInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.GetInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.GetInstanceRequest.to_json(
                cloud_redis.GetInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = cloud_redis.Instance.from_json(
                response.content,
    ...
    class _ImportInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.ImportInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = cloud_redis.ImportInstanceRequest.to_json(
                cloud_redis.ImportInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.ImportInstanceRequest.to_json(
                cloud_redis.ImportInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _ListInstances(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.ListInstancesRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.ListInstancesRequest.to_json(
                cloud_redis.ListInstancesRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
            ...
            # Return the response
            resp = cloud_redis.ListInstancesResponse.from_json(
                response.content,
                ignore_unknown_fields=True
            )
    ...
    class _UpdateInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.UpdateInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.UpdateInstanceRequest.to_json(
                cloud_redis.UpdateInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    class _UpgradeInstance(CloudRedisRestStub):
        ...
        def __call__(self,
            ...
            request_kwargs = cloud_redis.UpgradeInstanceRequest.to_dict(request)
            transcoded_request = path_template.transcode(
                http_options, **request_kwargs)

            # Jsonify the request body
            body = cloud_redis.UpgradeInstanceRequest.to_json(
                cloud_redis.UpgradeInstanceRequest(transcoded_request['body']),                including_default_value_fields=False,
                use_integers_for_enums=False
            )
            uri = transcoded_request['uri']
            method = transcoded_request['method']
            ...
            # Jsonify the query params
            query_params = json.loads(cloud_redis.UpgradeInstanceRequest.to_json(
                cloud_redis.UpgradeInstanceRequest(transcoded_request['query_params']),
                including_default_value_fields=False,
                use_integers_for_enums=False
            ))
    ...
    def create_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("create_instance")
        if not stub:
            stub = self._STUBS["create_instance"] = self._CreateInstance(self._session, self._host, self._interceptor)
    ...
    def delete_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("delete_instance")
        if not stub:
            stub = self._STUBS["delete_instance"] = self._DeleteInstance(self._session, self._host, self._interceptor)
    ...
    def export_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("export_instance")
        if not stub:
            stub = self._STUBS["export_instance"] = self._ExportInstance(self._session, self._host, self._interceptor)
    ...
    def failover_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("failover_instance")
        if not stub:
            stub = self._STUBS["failover_instance"] = self._FailoverInstance(self._session, self._host, self._interceptor)
    ...
    def get_instance(self) -> Callable[
            ...
            cloud_redis.Instance]:
        stub = self._STUBS.get("get_instance")
        if not stub:
            stub = self._STUBS["get_instance"] = self._GetInstance(self._session, self._host, self._interceptor)
    ...
    def import_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("import_instance")
        if not stub:
            stub = self._STUBS["import_instance"] = self._ImportInstance(self._session, self._host, self._interceptor)
    ...
    def update_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("update_instance")
        if not stub:
            stub = self._STUBS["update_instance"] = self._UpdateInstance(self._session, self._host, self._interceptor)
    ...
    def upgrade_instance(self) -> Callable[
            ...
            operations_pb2.Operation]:
        stub = self._STUBS.get("upgrade_instance")
        if not stub:
            stub = self._STUBS["upgrade_instance"] = self._UpgradeInstance(self._session, self._host, self._interceptor)
